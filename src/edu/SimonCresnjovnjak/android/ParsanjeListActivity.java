...
public class ParsanjeListActivity extends ListActivity implements OnItemClickListener  {
	Application1 app;
	 Menu mMenu;
...
case R.id.zem:
			...
			Intent moj3=new Intent(this,KjeSemActivity.class);
			
			this.startActivityForResult(moj3, map);
